    ...
    <div class="row justify-content-sm-center">
        <div class="col col-sm-8 col-lg-6">
            <form action="" method="post">
                ...
                <button style="font-size:16px; "type="submit" name="login" class="button">Submit</button>
                <button style="font-size:16px; type="submit" name="registration" class="button"><a href="registration.php" >Registration</a></button>
            </form>
        </div>
    </div>
</div>
